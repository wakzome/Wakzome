...
(function () {
  ...
  var DESC_TIPOS = [
    'ALFINETE','BIQUÍNI','BLUSA','BLUSÃO','BODY','BOLERO','BOTAS','BOTINS',
    'BRINCOS','CACHECOL','CALÇA','CALÇAS','CALÇÃO','CAMISA','CAMISEIRO',
    'CAMISETA','CAMISOLA','CARTEIRA','CASACO','CHAPÉU','CHINELOS','CINTO',
    'CLUTCH','COLAR','COLETE','CONJUNTO','CUECA','DERBY','FATO DE BANHO',
    'KIMONO','LEGGING','LENÇO','MACACO','MALA','MINI SAIA','MOCHILA',
    'PANTUFA','PAREO','PASHMINA','PIJAMA','POLO','PONCHO','PULSEIRA',
    'SABRINAS','SAIA','SANDÁLIA','SAPATILHAS','SAPATO','SHOPPER',
    'SWEATSHIRT','T-SHIRT','TOP','TÚNICA','VESTIDO'
  ];

  var DESC_MODS = [
    'ALGODÃO','APLICAÇÃO','ASSIMÉTRICA','BÁSICO','BICO','BOMBAZINE',
    'BORDADO','BOTÃO','BRILHO','C/APLICAÇÃO','C/BOTÃO','C/CINTO',
    'C/FLORES','C/LANTEJOULAS','C/LAÇO','C/RENDA','C/ZIP','CAMBRAIA',
    'CAMURÇA','CANELADO','CETIM','CINTO','COMPRIDA','CROCHET','CROPPED',
    'CURTA','DEGRADÊ','DOURADO','ELASTICO','ESTAMPADO','FLORES','FOLHO',
    'FRANJAS','FRANZIDA','GEOMÉTRICO','GOLA','HOMEM','IMIT LINHO','JEANS',
    'LANTEJOULAS','LAÇO','LARGA','LEOPARDO','LICRA','LINHO','LUREX',
    'M/COMPRIDA','M/CURTA','MALHA','MANGA','METALIZADO','MIDI','MUSSELINA',
    'NAPA','OVERSIZE','PADRÃO','PELO','PLISSADA','POLIPELE','POPELINE',
    'PRINT','PRINT FLORES','PRINT LEOPARDO','PÉROLAS','RENDA','RISCAS',
    'SARJA','SEDA','TECIDO','TULE','VELUDO','XADREZ','ÉTNICA','ZIP'
  ];
