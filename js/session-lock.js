...
(function (global) {
  ...
  global.SessionLock = {
    /**
     * Create a lock instance for a module.
     * @param {string} moduleName  - 'parfois' | 'tam' | 'faturas_lisboa'
     * @param {object} sbClient    - Supabase JS v2 client instance
     * @returns {SessionLockInstance}
     */
