  ...
  function _injectStyles() {
    ...
    s.textContent =
      ...
      '.hadm-filter-container {' +
        ...
        'background:#f5f5f5 !important; padding:20px !important; border-radius:15px !important;' +
        'margin:20px auto !important; width:fit-content !important; max-width:calc(100% - 32px) !important;' +
        'border:1px solid #e0e0e0 !important; box-sizing:border-box !important;' +
      '}' +
      '.hadm-row {' +
