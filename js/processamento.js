...
(function () {
  ...
  if (!document.getElementById(STYLE_ID)) {
    ...
    style.textContent = [
      ...
      /* Wrapper */
      '#proc-content { width:100%; min-height:100%; background:#fff; padding:20px; display:flex; flex-direction:column; align-items:stretch; font-family:\'MontserratLight\', sans-serif; font-size:14px; font-weight:600; color:#000; }',
      '#proc-content .page-wrap { width:100%; max-width:none; min-width:0; }',
      ...
      /* Header card */
      '#proc-content .proc-header-card { background:#fff; border:1px solid #e6e6e6; border-radius:14px; padding:16px 20px; margin-bottom:10px; display:grid; grid-template-columns:1fr 1fr 1fr; gap:14px; align-items:end; max-width:860px; }',
      ...
      '#proc-content .proc-table-wrap { overflow:visible; width:100%; }',
      '#proc-content .proc-table-wrap table { border-collapse:collapse; white-space:nowrap; border-radius:0; border-spacing:0; width:auto; table-layout:auto; }',
